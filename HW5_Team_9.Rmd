...
# Compute estimated survival functions
estimated_survival_function_baseline <- survfit(cox_model)
estimated_survival_function_new_trial <- survfit(cox_model, newdata = data.frame(posres = 0, multi = 0, clinend = 1, budget = 8.5))

# Plot estimated baseline survival function
plot(estimated_survival_function_baseline, col = "blue", xlab = "Months", ylab = "Survival Probability", main = "Estimated Survival Functions")
legend("topright", legend = c("Baseline", "New Trial"), lty = 1, col = c("blue", "red"))

# Add estimated survival function for new clinical trial
lines(estimated_survival_function_new_trial, col = "red")
